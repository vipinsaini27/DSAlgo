...
class Solution:
    ...
    def cloneGraph(self, node):
        ...
        while stack:
            ...
            edges = n.neighbors
            for e in edges:
                if visited[e.label - 1] is None:
                    neighbor = UndirectedGraphNode(e.label)
                    visited[e.label - 1] = neighbor
                    stack.append(e)
                    stack2.append(neighbor)
                else:
                    neighbor = visited[e.label - 1]
                n2.neighbors.append(neighbor)

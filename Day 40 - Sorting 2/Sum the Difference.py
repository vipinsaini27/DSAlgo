...
You have to find all possible non-empty subsequence of the array of numbers and then, for each subsequence, find the
difference between the largest and smallest numbers in that subsequence. Then add up all the differences to get the
number.
...
Example:
1 2 3 4
If we take indexes 0 and 3, i.e., elements 1 and 4. There are 2 elements between them (2, 3).
